...
* Commits should be merged into corresponding pull requests on the  `master` branch and include extended changelogs, if possible.
* After code review and approval, merge pull requests to `master`.
